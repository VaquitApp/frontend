...
<svelte:head>
	<title>{title} - Nuevo Gasto Recurrente</title>
</svelte:head>
...
<form method="POST" autocomplete="off">
	<fieldset>
		...
		<label>
			Ingrese el grupo al que pertenece el gasto recurrente
			<select
				name="groupId"
				required
		...
		<label>
			Ingrese la categoría a la que pertenece el gasto recurrente
		...
		<label>
			Ingrese una descripción para el gasto recurrente
			<input
				type="text"
				name="description"
